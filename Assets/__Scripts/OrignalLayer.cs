...
public class OrignalLayer : MonoBehaviour
{
	...
	*/
	...
	<slot id = "27" x="9"  y="-2" faceup="1" layer="3" />
		...
		<!-- Layer0, the deepest cards. -->
	<slot id="27" x="0" y="3.5" faceup="0" layer="0" />
	
	<!-- Layer1, the next level. -->
	<slot id="25" x="-1" y="2.5" faceup="0" layer="1" hiddenby="27" />
	<slot id="26" x="1" y="2.5" faceup="0" layer="1" hiddenby="27" />

	<!-- Layer2, the next level. -->
	<slot id="22" x="-2" y="1.5" faceup="0" layer="2" hiddenby="25" />
	<slot id="23" x="0" y="1.5" faceup="0" layer="2" hiddenby="25,26" />
	<slot id="24" x="2" y="1.5" faceup="0" layer="2" hiddenby="26" />
	...
	<slot type="discardpile" x="-2.3" y="-5" layer="8"/>
		...
		<!-- Layer3, the next level. -->
	<slot id="18" x="-3" y="0.5" faceup="0" layer="0" />
	<slot id="19" x="-1" y="0.5" faceup="0" layer="0" />
	<slot id="20" x="1" y="0.5" faceup="0" layer="0"  />
	<slot id="21" x="3" y="0.5" faceup="0" layer="0"  />
	
	<!-- Layer4, the next level. -->
	<slot id="13" x="-4" y="-0.5" faceup="0" layer="1" hiddenby="18" />
	<slot id="14" x="-2" y="-0.5" faceup="0" layer="1" hiddenby="18,19" />
	<slot id="15" x="0" y="-0.5" faceup="0" layer="1" hiddenby="19,20" />
	<slot id="16" x="2" y="-0.5" faceup="0" layer="1" hiddenby="20,21" />
	<slot id="17" x="4" y="-0.5" faceup="0" layer="1" hiddenby="21" />
	
	<!-- Layer5, the next level. -->
	<slot id="7" x="-5" y="-1.5" faceup="0" layer="2" hiddenby="13" />
	<slot id="8" x="-3" y="-1.5" faceup="0" layer="2" hiddenby="13,14" />
	<slot id="9" x="-1" y="-1.5" faceup="0" layer="2" hiddenby="14,15" />
	<slot id="10" x="1" y="-1.5" faceup="0" layer="2" hiddenby="15,16" />
	<slot id="11" x="3" y="-1.5" faceup="0" layer="2" hiddenby="16,17" />
	<slot id="12" x="5" y="-1.5" faceup="0" layer="2" hiddenby="17" />
	
	<!-- Layer6, the top level. -->
	<slot id="0" x="-6" y="-2.5" faceup="1" layer="3" hiddenby="7" />
	<slot id="1" x="-4" y="-2.5" faceup="1" layer="3" hiddenby="7,8" />
	<slot id="2" x="-2" y="-2.5" faceup="1" layer="3" hiddenby="8,9" />
	<slot id="3" x="0" y="-2.5" faceup="1" layer="3" hiddenby="9,10" />
	<slot id="4" x="2" y="-2.5" faceup="1" layer="3" hiddenby="10,11" />
	<slot id="5" x="4" y="-2.5" faceup="1" layer="3" hiddenby="11,12" />
	<slot id="6" x="6" y="-2.5" faceup="1" layer="3" hiddenby="12" />
